...
public interface ReservationRepository extends JpaRepository<Reservation,Long> {
    ...
    "LEFT JOIN fetch r.carId cd " +    // reservation icindeki carId field ini kullanarak Car classına ulasabilecegimiz
    "LEFT JOIN fetch cd.image img " +  // cd objesi olusturduk cd.image ile car classindaki image e ulastik
    "LEFT JOIN fetch r.userId uid " +  // uid objesi ile user bilgilerine ulastik
