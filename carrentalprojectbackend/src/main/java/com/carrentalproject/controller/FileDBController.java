...
import com.carrentalproject.dto.FileDTO;
import com.carrentalproject.service.FileDBService;
...
public class FileDBController {
    ...
    public final FileDBService fileDBService;
    ...
    @GetMapping("")
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<List<FileDTO>> getAllFiles(){ //tum dosyalari getirmek icin
